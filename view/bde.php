...
<script type="text/javascript">
	...
	function goToRetour(){
		...
		document.getElementById('date_ouverture').value = document.getElementById('input_ouverture').value;
		document.getElementById('date_fermeture').value = document.getElementById('input_fermeture').value;
